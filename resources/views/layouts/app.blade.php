...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if (Route::currentRouteName() == 'list') active @endif"
                                href="{{ route('list') }}">Book List</a>
                        </li>
                        <li class="nav-item">
        ...
        {{-- <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <span style="color: #4ba5aa">Berkah</span> Library
                </a>
    ...
    <footer class="bg-light bg-gradient text-center text-lg-start">
        <!-- Copyright -->
